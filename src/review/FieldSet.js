...
export default function FieldSet({AppName}){
    return(
        <fieldset>
            ...
            <textarea id={`${AppName}Feedback`} name={`${AppName}Feedback`} rows="4" cols="50" placeholder={`What did you like or dislike about the ${AppName} App? (Optional)`}></textarea><br /><br />
        </fieldset>
    ); 
}
